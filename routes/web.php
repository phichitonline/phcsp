...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // ระบบเอกสารประจำตัว (Personal Documents)
    ...
    Route::get('/personal-documents/{id}/view', [PersonalDocumentController::class, 'view'])->name('personal-documents.view');
    Route::get('/personal-documents/{id}/download', [PersonalDocumentController::class, 'download'])->name('personal-documents.download');
    Route::delete('/personal-documents/{id}', [PersonalDocumentController::class, 'destroy'])->name('personal-documents.destroy');

    // จัดการเอกสารมาตรฐาน (Admin Standard Documents)
    Route::post('/standard-documents', [StandardDocumentController::class, 'store'])->name('standard-documents.store');
    Route::put('/standard-documents/{id}', [StandardDocumentController::class, 'update'])->name('standard-documents.update');
    Route::delete('/standard-documents/{id}', [StandardDocumentController::class, 'destroy'])->name('standard-documents.destroy');
    Route::post('/standard-documents/reorder', [StandardDocumentController::class, 'reorder'])->name('standard-documents.reorder');

    // ระบบทะเบียนประวัตินักศึกษา (Student Profile & Registry)
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::post('/admin/students/{id}/update-profile', [StudentManagementController::class, 'updateProfile'])->name('admin.students.update-profile');
    });
